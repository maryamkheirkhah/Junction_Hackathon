...
const getAIAnalysis = (description: string) => {
  ...
  const variation = Math.min(
    Math.max(Math.random() * 6 - 2.1, -baseRate),
    100 - baseRate
  );
  const acceptanceRate = Math.max(
    0,
    Math.min(baseRate + parseFloat(variation.toFixed(1)), 100)
  );
...
export default function TicketAnalysisPage() {
  ...
  return (
    <div className="container mx-auto py-6">
      <h1 className="text-3xl font-bold text-[#3E5660] mb-6">
        AI Ticket Analysis
      </h1>
              ...
              <>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-[#4d9d88]">
                      ...
                      {analysis.acceptanceRate.toFixed(1)}%)
                    </span>
                    <span className="text-[#D5121E]">
                      Rejection Probability (
                      {(100 - analysis.acceptanceRate).toFixed(1)}%)
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold">
                    Key Factors Based on Historical Analysis:
                  </h3>
                ...
                <div className="flex justify-end space-x-4">
                  <Button onClick={handleSubmit} className="bg-[#D5121E] gap-2">
